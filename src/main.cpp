...
uint256 hashGenesisBlock("0x15bb4f4cf18b92ece6eccdf989426eb19300a0c5b9f45dfaa7f140eb6702368b");
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // BnrtxCoin: 0.35 days
static const int64 nTargetSpacing = 10; // BnrtxCoin: 10 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal BnrtxCoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "BnrtxCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x0f24ba6836e4676f394093de989616ae1e0448d1abbde8d60c1a0f6c78ad3c47");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        block.nVersion = 1;
        block.nTime    = 1433644279;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 389063734;

        if (fTestNet)
        {
            block.nTime    = 1433604658;
